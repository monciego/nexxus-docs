...
- <Badge text="Draft" variant="note" /> — Save the call sheet as a draft to keep
  working on it later.
- <Badge text="Published" variant="success" /> — Publish the call sheet to
  finalize it and make it available for sharing.
